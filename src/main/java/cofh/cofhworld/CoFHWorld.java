...
@Mod (modid = CoFHWorld.MOD_ID, name = CoFHWorld.MOD_NAME, version = CoFHWorld.VERSION, dependencies = CoFHWorld.DEPENDENCIES, updateJSON = CoFHWorld.UPDATE_URL, acceptableRemoteVersions = "*", guiFactory = "", certificateFingerprint = "8a6abf2cb9e141b866580d369ba6548732eff25f")
