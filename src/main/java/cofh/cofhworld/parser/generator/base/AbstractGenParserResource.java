...
public interface AbstractGenParserResource<T extends WorldGen, B extends BaseBuilder<T>> extends AbstractGenParserMaterial<T, B> {

	@Override
	default void getFields(IBuilderFieldRegistry<T, B> fields) {

		AbstractGenParserMaterial.super.getFields(fields);
		fields.addRequiredField("resource", Type.BLOCK_LIST, BaseBuilder::setResource, "block");
	}
}
