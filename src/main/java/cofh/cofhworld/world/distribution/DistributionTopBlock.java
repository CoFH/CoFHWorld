...
public class DistributionTopBlock extends Distribution {
	...
	public DistributionTopBlock(String name, WorldGenerator worldGen, List<WeightedRandomBlock> matList, INumberProvider count, GenRestriction biomeRes, boolean regen, GenRestriction dimRes) {
